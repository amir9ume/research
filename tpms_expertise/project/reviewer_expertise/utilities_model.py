...
def get_train_test_data_from_hidden_representations(rep,data_path,device):
    ...
    if rep=="BOW":
        data_sub, data_rev, data_y, submitter_ids, reviewer_ids = prepare_data_bow(paper_representation, reviewer_representation, df,device)
    else:
        data_sub, data_rev, data_y, submitter_ids, reviewer_ids = prepare_data(paper_representation, reviewer_representation, df,device)
...
def get_data_particular_reviewer_with_ids(rep,data_path, find_reviewer_ids,device):
    ...
    if rep=="BOW":
        data_sub, data_rev, data_y, submitter_ids, reviewer_ids = prepare_data_find_reviewer_ids(paper_representation, reviewer_representation, df, find_reviewer_ids,device)
    else:
        data_sub, data_rev, data_y, submitter_ids, reviewer_ids = prepare_data_find_reviewer_ids(paper_representation, reviewer_representation, df,find_reviewer_ids,device)
